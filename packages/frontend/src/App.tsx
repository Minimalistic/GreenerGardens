...
const InitialSetupPage = lazy(() => import('@/pages/initial-setup').then(m => ({ default: m.InitialSetupPage })));
          ...
          <Route element={<AuthGuard />}>
            ...
            <Route element={<SetupGuard />}>
              <Route element={<PinGate />}>
                <Route element={<GardenProvider><UndoRedoProvider><AssistantProvider><AppShell /></AssistantProvider></UndoRedoProvider></GardenProvider>}>
