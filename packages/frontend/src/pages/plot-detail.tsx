...
import { PlantAssignmentDialog } from '@/components/garden/plant-assignment-dialog';
...
import { ArrowLeft, Layers, Sprout, Plus, Trash2, X, Copy, ExternalLink, ClipboardList } from 'lucide-react';
                ...
                {selectedSubPlot.plant_instance_id ? (
                  <>
                    ...
                    <div className="space-y-1">
                      ...
                      <EditableDateField
                        value={selectedSubPlot.expected_harvest_date}
                        onSave={async (val) => {
                          try {
