...
export function registerDataRoutes(fastify: FastifyInstance, db: Database.Database, history: HistoryLogger, gardenRepo: GardenRepository) {
  ...
  adminRoutes(fastify, db, gardenRepo);
