...
import type { SubPlotRepository, SubPlotRow } from '../db/repositories/sub-plot.repository.js';
...
export class SubPlotService {
  ...
  create(data: unknown) {
    ...
    const row: Record<string, any> = {
      ...
      grid_row: parsed.grid_position.row,
      grid_col: parsed.grid_position.col,
